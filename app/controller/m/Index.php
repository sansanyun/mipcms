        ...
        if ($this->mipInfo['superSites'] && $category) {
            ...
            if ($categoryList) {
                foreach ($categoryList as $key => $val) {
                    $categoryList[$key]['url'] = $this->mipInfo['httpType'] .$category . '.' . $this->mipInfo['topDomain'] . $this->rewrite .'/' . $val['url_name'] . '/';
                    if ($this->mipInfo['mipDomain']) {
                        $categoryList[$key]['mipUrl'] = $this->mipInfo['httpType'] . 'm.' . $category . '.' . $this->mipInfo['topDomain'] . $this->rewrite .'/' . $val['url_name'] . '/';
                    }
