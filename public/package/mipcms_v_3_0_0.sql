...
-- ----------------------------
BEGIN;
INSERT INTO `mip_articles_category` VALUES ('1', '文章', '0', '99', '', '', null, 'article', '0', '');
COMMIT;
