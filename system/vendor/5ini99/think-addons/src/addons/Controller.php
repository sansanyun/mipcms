...
//      $convert = \think\Config::get('url_convert');
        $act = $this->request->dispatch()['method'][4];
        $ctr = $this->request->dispatch()['method'][3];
        $mod = $this->request->dispatch()['method'][2];
        $this->action = $act ? $act : 'index';
        $this->controller = $ctr ? $ctr : 'Index';
        $this->addon = $mod ? $mod : 'index';
