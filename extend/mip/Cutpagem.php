...
class Cutpagem {
        ...
        function pagenav($currentPageNum, $url,$urlPageBreak,$current) {
            $str = '';
            for($i=1; $i <= $this->sum_page; $i++) {
                if($i == $this->ipage) {
                    $str.= "<li class='active'><a data-type='mip' href=".$current.">".$i."</a></li>";
                } else {
                    if ($i == 1) {
                        $str.= "<li><a data-type='mip' href='" . $url . ".html'>".$i."</a></li>";
                    } else {
                        $str.= "<li><a data-type='mip' href='" . $url . $urlPageBreak . $i .".html'>".$i."</a></li>";
                    }
                }
            }
            return $str;      
