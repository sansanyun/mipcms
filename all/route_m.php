...
Route::domain($mipInfo['mipDomain'], function() use($mipInfo) {
    ...
    Route::rule([$mipInfo['tagModelUrl'].'/[:id]/index_<page>'=>['m/Tag/tagDetail',['ext'=>'html'],['id'=>'^[a-zA-Z0-9]+'],['page'=>'\d+']]]);
...
if ($mipInfo['mipDomain']) {
    if ($mipInfo['superSites']) {
        ...
        Route::group($mipInfo['tagModelUrl'], [
            '[:id]/index_<page>'=>  ['m/Tag/tagDetail',['ext'=>'html'],['id'=>'^[a-zA-Z0-9]+'],['page'=>'\d+']],
            ':id'=>  ['m/Tag/tagDetail',[],['id'=>'^[a-zA-Z0-9]+']],
        ],[],[]);
